...
func init() {
	m.Register(func(db dbx.Builder) error {
		...
		// add
		new_Max_external_guests := &schema.SchemaField{}
		if err := json.Unmarshal([]byte(`{
			"system": false,
			"id": "ucqms3oy",
		...
		}`), new_Max_external_guests); err != nil {
			return err
		}
		collection.Schema.AddField(new_Max_external_guests)
		...
		// remove
		collection.Schema.RemoveField("ucqms3oy")
